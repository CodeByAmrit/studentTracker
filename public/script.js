...
// document
//   .getElementById('validationZip')
//   .addEventListener('change', function (zip) {
//     const pincode = document.getElementById('validationZip').value // Replace with the desired pincode
...
//           document.getElementById('validationState').value =
//             data[0].PostOffice[0].State
//           document.getElementById('validationDistrict').value =
//             data[0].PostOffice[0].District
//           // console.log('State:', data[0].PostOffice[0].State)
//           // document.getElementById.value = console.log('District:',data[0].PostOffice[0].District)
//         } else {
